...
async function handleSubmit(event) {
    ...
    // get search results, clean previous results if needed
...
async function searchWikipedia(searchQuery) {
    const nsearch = 20;
    const endpoint = `https://en.wikipedia.org/w/api.php?action=query&list=search&prop=info&inprop=url&utf8=&format=json&origin=*&srlimit=${nsearch}&srsearch=${searchQuery}`;
